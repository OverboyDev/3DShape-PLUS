...
readme.push(`The main files you may want to look at would be instance.js and scriptInterface.js`)
...
Object.keys(config.Acts).forEach((key) => {
	...
	readme.push(`| ${action.listName} | ${action.description} | ${paramString} |`)
})
readme.push(``)
...
Object.keys(config.Cnds).forEach((key) => {
	...
	readme.push(`| ${condition.listName} | ${condition.description} | ${paramString} |`)
})
readme.push(``)
...
Object.keys(config.Exps).forEach((key) => {
	...
	readme.push(`| ${key} | ${expression.description} | ${expression.returnType} | ${paramString} | `)
})
readme.push(``)
